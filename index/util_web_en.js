...
function showdiv(str,CloseMode) {  
	...
	var strclose1 ='<br><br><br><input type="button" value="Close" onClick="closediv('+CloseMode+');" style="border:0;cursor:pointer" >';
    msgw = 400; //提示窗口的宽度    
    msgh = 100; //提示窗口的高度    
...
//					location.reload();
            ...
            else 
			{
				...
				updatedivmsg("Update Success!",DivCloseMode_Reload);
				//updatedivmsg("Update Failure!"+"Request was unsuccessful:" + xhr.status,DivCloseMode_Reload);				
