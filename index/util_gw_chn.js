...
var ntp_zone_chn_array=new Array(65);
ntp_zone_chn_array[0]=new ntp_entry("(GMT-12:00)埃尼威托克, 夸贾林环礁","12 1");
ntp_zone_chn_array[1]=new ntp_entry("(GMT-11:00)中途岛, 萨摩亚群岛","11 1");
ntp_zone_chn_array[2]=new ntp_entry("(GMT-10:00)夏威夷", "10 1");
ntp_zone_chn_array[3]=new ntp_entry("(GMT-09:00)阿拉斯加", "9 1");
ntp_zone_chn_array[4]=new ntp_entry("(GMT-08:00)太平洋时间(美国和加拿大)", "8 1");
ntp_zone_chn_array[5]=new ntp_entry("(GMT-07:00)亚利桑那", "7 1");
ntp_zone_chn_array[6]=new ntp_entry("(GMT-07:00)山地时间(美国和加拿大)", "7 2");
ntp_zone_chn_array[7]=new ntp_entry("(GMT-06:00)中部时间(美国和加拿大)", "6 1");
ntp_zone_chn_array[8]=new ntp_entry("(GMT-06:00)墨西哥城, 特古西加尔巴", "6 2");
ntp_zone_chn_array[9]=new ntp_entry("(GMT-06:00)萨斯喀彻温", "6 3");
ntp_zone_chn_array[10]=new ntp_entry("(GMT-05:00)波哥大, 利马, 基多", "5 1");
ntp_zone_chn_array[11]=new ntp_entry("(GMT-05:00)东部时间(美国和加拿大)", "5 2");
ntp_zone_chn_array[12]=new ntp_entry("(GMT-05:00)印第安纳州(东部)", "5 3");
ntp_zone_chn_array[13]=new ntp_entry("(GMT-04:00)大西洋时间(加拿大)", "4 1");
ntp_zone_chn_array[14]=new ntp_entry("(GMT-04:00)加拉加斯, 拉巴斯", "4 2");
ntp_zone_chn_array[15]=new ntp_entry("(GMT-04:00)圣地亚哥", "4 3");
ntp_zone_chn_array[16]=new ntp_entry("(GMT-03:30)纽芬兰", "3 1");
ntp_zone_chn_array[17]=new ntp_entry("(GMT-03:00)巴西利亚", "3 2");
ntp_zone_chn_array[18]=new ntp_entry("(GMT-03:00)布宜诺斯艾利斯, 乔治敦", "3 3");
ntp_zone_chn_array[19]=new ntp_entry("(GMT-02:00)中大西洋", "2 1");
ntp_zone_chn_array[20]=new ntp_entry("(GMT-01:00)亚速尔群岛, 佛得角群岛", "1 1");
ntp_zone_chn_array[21]=new ntp_entry("(GMT)卡萨布兰卡, 蒙罗维亚", "0 1");
ntp_zone_chn_array[22]=new ntp_entry("(GMT)格林尼治标准时间: 都柏林, 爱丁堡, 里斯本, 伦敦", "0 2");
ntp_zone_chn_array[23]=new ntp_entry("(GMT+01:00)阿姆斯特丹, 柏林, 伯尔尼, 罗马, 斯德哥尔摩, 维也纳", "-1 1");
ntp_zone_chn_array[24]=new ntp_entry("(GMT+01:00)贝尔格莱德, 布拉迪斯拉发, 布达佩斯, 卢布尔雅那, 布拉格", "-1 2");
ntp_zone_chn_array[25]=new ntp_entry("(GMT+01:00)巴塞罗那, 马德里", "-1 3");
ntp_zone_chn_array[26]=new ntp_entry("(GMT+01:00)布鲁塞尔, 哥本哈根, 马德里, 巴黎, 维尔纽斯", "-1 4");
ntp_zone_chn_array[27]=new ntp_entry("(GMT+01:00)巴黎", "-1 5");
ntp_zone_chn_array[28]=new ntp_entry("(GMT+01:00).萨拉热窝, 斯科普里, 索菲亚, 华沙, 萨格勒布", "-1 6");
ntp_zone_chn_array[29]=new ntp_entry("(GMT+02:00)雅典, 伊斯坦布尔, 明斯克", "-2 1");
ntp_zone_chn_array[30]=new ntp_entry("(GMT+02:00)布加勒斯特", "-2 2");
ntp_zone_chn_array[31]=new ntp_entry("(GMT+02:00)开罗", "-2 3");
ntp_zone_chn_array[32]=new ntp_entry("(GMT+02:00)哈拉雷, 比勒陀利亚", "-2 4");
ntp_zone_chn_array[33]=new ntp_entry("(GMT+02:00)赫尔辛基, 里加, 塔林", "-2 5");
ntp_zone_chn_array[34]=new ntp_entry("(GMT+02:00)耶路撒冷", "-2 6");
ntp_zone_chn_array[35]=new ntp_entry("(GMT+03:00)巴格达, 科威特, 利雅得", "-3 1");
ntp_zone_chn_array[36]=new ntp_entry("(GMT+03:00)莫斯科, 圣彼得堡, 伏尔加格勒", "-3 2");
ntp_zone_chn_array[37]=new ntp_entry("(GMT+03:00)内罗毕", "-3 3");
ntp_zone_chn_array[38]=new ntp_entry("(GMT+03:30)德黑兰", "-3 4");
ntp_zone_chn_array[39]=new ntp_entry("(GMT+04:00)阿布扎比, 马斯喀特", "-4 1");
ntp_zone_chn_array[40]=new ntp_entry("(GMT+04:00)巴库, 第比利斯", "-4 2");
ntp_zone_chn_array[41]=new ntp_entry("(GMT+04:30)喀布尔", "-4 3");
ntp_zone_chn_array[42]=new ntp_entry("(GMT+05:00)叶卡捷琳堡", "-5 1");
ntp_zone_chn_array[43]=new ntp_entry("(GMT+05:00)伊斯兰堡, 卡拉奇, 塔什干", "-5 2");
ntp_zone_chn_array[44]=new ntp_entry("(GMT+05:30)孟买, 加尔各答, 马德拉斯, 新德里", "-5 3");
ntp_zone_chn_array[45]=new ntp_entry("(GMT+06:00)阿斯塔纳, 阿拉木图, 达卡", "-6 1");
ntp_zone_chn_array[46]=new ntp_entry("(GMT+06:00)科伦坡", "-6 2");
ntp_zone_chn_array[47]=new ntp_entry("(GMT+07:00)曼谷, 河内, 雅加达", "-7 1");
ntp_zone_chn_array[48]=new ntp_entry("(GMT+08:00)北京, 重庆, 香港特别行政区, 乌鲁木齐", "-8 1");
ntp_zone_chn_array[49]=new ntp_entry("(GMT+08:00)珀斯", "-8 2");
ntp_zone_chn_array[50]=new ntp_entry("(GMT+08:00)新加坡", "-8 3");
ntp_zone_chn_array[51]=new ntp_entry("(GMT+08:00)台北", "-8 4");
ntp_zone_chn_array[52]=new ntp_entry("(GMT+09:00)大阪, 札幌, 东京", "-9 1");
ntp_zone_chn_array[53]=new ntp_entry("(GMT+09:00)首尔", "-9 2");
ntp_zone_chn_array[54]=new ntp_entry("(GMT+09:00)雅库茨克", "-9 3");
ntp_zone_chn_array[55]=new ntp_entry("(GMT+09:30)阿德莱德", "-9 4");
ntp_zone_chn_array[56]=new ntp_entry("(GMT+09:30)达尔文", "-9 5");
ntp_zone_chn_array[57]=new ntp_entry("(GMT+10:00)布里斯班", "-10 1");
ntp_zone_chn_array[58]=new ntp_entry("(GMT+10:00)堪培拉, 墨尔本, 悉尼", "-10 2");
ntp_zone_chn_array[59]=new ntp_entry("(GMT+10:00)关岛, 莫尔兹比港", "-10 3");
ntp_zone_chn_array[60]=new ntp_entry("(GMT+10:00)霍巴特", "-10 4");
ntp_zone_chn_array[61]=new ntp_entry("(GMT+10:00)符拉迪沃斯托克", "-10 5");
ntp_zone_chn_array[62]=new ntp_entry("(GMT+11:00)马加丹, 所罗门群岛, 新喀里多尼亚", "-11 1");
ntp_zone_chn_array[63]=new ntp_entry("(GMT+12:00)奥克兰, 惠灵顿", "-12 1");
ntp_zone_chn_array[64]=new ntp_entry("(GMT+12:00)斐济, 堪察加半岛, 马绍尔群岛", "-12 2");
